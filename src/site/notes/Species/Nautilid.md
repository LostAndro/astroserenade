---
{"dg-publish":true,"permalink":"/species/nautilid/","dg-note-properties":{}}
---

#### [[Species\|Species]]
# Nautilid
![Nautilid.png](/img/user/images/Nautilid.png)
...
As a Nautilid, you have these special traits
	***Amphibious***. You can breathe underwater. However, without your Aqua Suit, breathing air is uncomfortable for you, feeling similar to a human in very thin air.
	...
	***Aqua Suit***. Except when you are aboard a whorl ship, you wear a bulky Aqua Suit, which is filled with Poseidon Solution, in order to breathe comfortably. The suit covers your whole body, including a large domed helmet that allows you to see without hindrance.
	You can don or doff the helmet on your turn (no action required), and you can don or doff the entire suit in 1 minute. If damaged but not completely destroyed, the suit rapidly mends itself, leaking a minimum amount of water. While wearing the suit, you gain the following benefits.
	**Armored Suit**. Your base Armor Class equals 13 plus your Dexterity modifier. You can fit armor around your Aqua Suit and wear both simultaneously, using either armor to determine your AC. You can use a Shield and still gain this benefit. 
	**Fire Resistance**. You have Resistance to Fire damage.
	**Life Suit**. You gain the benefits of wearing a Life Suit.
	**Universal Translator**. You can use the suit’s embedded Universal Translator magic item at will.
### Species Lineup
